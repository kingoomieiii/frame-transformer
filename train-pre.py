...
def main():
    ...
    p.add_argument('--batch_sizes', type=str, default='8,1')
    p.add_argument('--accumulation_steps', '-A', type=str, default='2,16')
    ...
    model = FrameTransformer(channels=args.channels, n_fft=args.n_fft, dropout=args.dropout, expansion=args.feedforward_expansion, num_heads=args.num_heads, num_res_blocks=2, pretraining=True)
