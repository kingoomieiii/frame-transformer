...
def main():
    ...
    p.add_argument('--checkpoint', type=str, default='/media/ben/internal-nvme-b/models/local.45.voxaug.pth')
    ...
    p.add_argument('--channels', type=int, default=36)
    ...
    model = FrameTransformer(in_channels=2, out_channels=2, channels=args.channels, expansion=args.expansion, n_fft=args.n_fft, dropout=args.dropout, num_heads=args.num_heads, num_attention_maps=args.num_attention_maps, num_bridge_layers=args.num_bridge_layers, latent_expansion=args.latent_expansion)
