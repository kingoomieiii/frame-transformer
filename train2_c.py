...
from dataset_codegen import CodeGenDataset

from dataset_voxaug2 import VoxAugDataset
from frame_transformer_thin import FrameTransformer as FrameTransformerV1
from frame_transformer_c import FrameTransformer
from dense_frame_embedding import DenseFrameEmbedding
...
def main():
    ...
    p.add_argument('--dataset', type=str, default="D://cs2048_sr44100_hl1024_nf2048_of0_PAIRS")
    ...
    args.dataset = [p for p in args.dataset.split('|')]
    ...
    model = FrameTransformer(in_channels=8, dropout=args.dropout, n_fft=args.n_fft, num_heads=args.num_heads, expansion=args.expansion, num_layers=args.num_layers)
    ...
    if args.v1_checkpoint is not None:
