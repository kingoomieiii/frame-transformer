...
def main():
    ...
    p.add_argument('--instrumental_lib', type=str, default="C://cs2048_sr44100_hl1024_nf2048_of0|D://cs2048_sr44100_hl1024_nf2048_of0|F://cs2048_sr44100_hl1024_nf2048_of0|H://cs2048_sr44100_hl1024_nf2048_of0|D://cs2048_sr44100_hl1024_nf2048_of0_pretraining|F://cs2048_sr44100_hl1024_nf2048_of0_pretraining|H://cs2048_sr44100_hl1024_nf2048_of0_pretraining")
    ...
    while step < args.stages[-1]:
        ...
        train_loss_mag, disc_loss, step = train_epoch(train_dataloader, generator, device, optimizer=optimizer_gen, accumulation_steps=accum_steps, progress_bar=args.progress_bar, lr_warmup=scheduler_gen, grad_scaler=grad_scaler_gen, step=step)
