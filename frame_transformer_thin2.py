...
class FrameTransformer(nn.Module):
    ...
    def load_from_other(self, other):        
        self._load_from_encoder(self.enc0_transformer, other.enc0_transformer)
        self._load_from_encoder(self.enc1_transformer, other.enc1_transformer)
        self._load_from_encoder(self.enc2_transformer, other.enc2_transformer)
        self._load_from_encoder(self.enc3_transformer, other.enc3_transformer)
        self._load_from_encoder(self.enc4_transformer, other.enc4_transformer)
        self._load_from_encoder(self.enc5_transformer, other.enc5_transformer)
        self._load_from_encoder(self.enc6_transformer, other.enc6_transformer)
        self._load_from_decoder(self.dec1_transformer, other.dec1_transformer)
        self._load_from_decoder(self.dec2_transformer, other.dec2_transformer)
        self._load_from_decoder(self.dec3_transformer, other.dec3_transformer)
        self._load_from_decoder(self.dec4_transformer, other.dec4_transformer)
        self._load_from_decoder(self.dec5_transformer, other.dec5_transformer)

    def _load_from_encoder(self, encoder, other):
        encoder.norm1 = other.norm1
        encoder.attn = other.attn
        encoder.norm2 = other.norm2
        encoder.conv1 = other.conv1
        encoder.conv2 = other.conv2

    def _load_from_decoder(self, decoder, other):
        decoder.norm1 = other.norm1
        decoder.attn1 = other.attn1
        decoder.norm2 = other.norm2
        decoder.attn2 = other.attn2
        decoder.norm3 = other.norm3
        decoder.conv1 = other.conv1
        decoder.conv2 = other.conv2
