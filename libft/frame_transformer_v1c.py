...
class FrameTransformer(nn.Module):
    def __init__(self, in_channels=2, out_channels=2, channels=2, dropout=0.1, n_fft=2048, num_heads=4, expansion=4, num_bridge_layers=16, num_attention_maps=4):
    ...
    def forward(self, x):
        ...
        e9 = self.enc9(e8)
        e9, _, qk9 = self.enc9_transformer(e9, prev_qk=qk8)

        h = self.dec8(e9, e8)
        h, pqk1, pqk2 = self.dec8_transformer(h, a8, prev_qk1=qk9, prev_qk2=None, skip_qk=qk8)
