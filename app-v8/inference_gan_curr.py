...
def main():
    ...
    p.add_argument('--pretrained_model', '-P', type=str, default='/media/ben/internal-nvme-b/models/local.52.modelt.pth')
    ...
    model = FrameTransformerGenerator(in_channels=2, channels=args.channels, n_fft=args.n_fft, expansion=args.expansion, num_heads=args.num_heads)
