...
from frame_primer.common import FramePrimerDecoder, FramePrimerEncoder, FrameEncoder, FrameDecoder, FrameDecoder2, FrameEncoder2, FramePrimerEncoder2, FramePrimerDecoder2
...
class FramePrimer2(nn.Module):
    def __init__(self, in_channels=2, channels=2, dropout=0.1, n_fft=2048, feedforward_dim=2048, num_res_blocks=1, num_heads=[1, 1, 1, 1, 1, 1], expansion=2):
        ...
        self.enc1_primer = FramePrimerEncoder(channels, num_heads=num_heads[0], n_fft=n_fft, downsamples=0, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.enc2_primer = FramePrimerEncoder(channels * 2, num_heads=num_heads[1], n_fft=n_fft, downsamples=1, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.enc3_primer = FramePrimerEncoder(channels * 4, num_heads=num_heads[2], n_fft=n_fft, downsamples=2, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.enc4_primer = FramePrimerEncoder(channels * 6, num_heads=num_heads[3], n_fft=n_fft, downsamples=3, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.enc5_primer = FramePrimerEncoder(channels * 8, num_heads=num_heads[4], n_fft=n_fft, downsamples=4, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.enc6_primer = FramePrimerEncoder(channels * 10, num_heads=num_heads[5], n_fft=n_fft, downsamples=5, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.dec5_primer = FramePrimerDecoder(channels * 8, num_heads=num_heads[4], n_fft=n_fft, downsamples=4, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.dec4_primer = FramePrimerDecoder(channels * 6, num_heads=num_heads[3], n_fft=n_fft, downsamples=3, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.dec3_primer = FramePrimerDecoder(channels * 4, num_heads=num_heads[2], n_fft=n_fft, downsamples=2, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.dec2_primer = FramePrimerDecoder(channels * 2, num_heads=num_heads[1], n_fft=n_fft, downsamples=1, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
        ...
        self.dec1_primer = FramePrimerDecoder(channels * 1, num_heads=num_heads[0], n_fft=n_fft, downsamples=0, dropout=dropout, expansion=expansion, feedforward_dim=feedforward_dim)
...
class FramePrimer3(nn.Module):
    def __init__(self, in_channels=2, channels=2, dropout=0.1, n_fft=2048, feedforward_dim=2048, num_res_blocks=1, num_heads=[8, 8, 8, 8, 4, 4], expansion=4):
        super(FramePrimer3, self).__init__()
        
        self.max_bin = n_fft // 2
        self.output_bin = n_fft // 2 + 1

        self.enc1 = FrameEncoder2(in_channels, channels, n_fft=n_fft, downsamples=0,downsample=False)
        self.enc1_primer = FramePrimerEncoder2(channels, num_heads=num_heads[0], n_fft=n_fft, downsamples=0, dropout=dropout, expansion=expansion)

        self.enc2 = FrameEncoder2(channels, channels * 2, n_fft=n_fft, downsamples=0)
        self.enc2_primer = FramePrimerEncoder2(channels * 2, num_heads=num_heads[1], n_fft=n_fft, downsamples=1, dropout=dropout, expansion=expansion)

        self.enc3 = FrameEncoder2(channels * 2, channels * 4, n_fft=n_fft, downsamples=1)
        self.enc3_primer = FramePrimerEncoder2(channels * 4, num_heads=num_heads[2], n_fft=n_fft, downsamples=2, dropout=dropout, expansion=expansion)

        self.enc4 = FrameEncoder2(channels * 4, channels * 6, n_fft=n_fft, downsamples=2)
        self.enc4_primer = FramePrimerEncoder2(channels * 6, num_heads=num_heads[3], n_fft=n_fft, downsamples=3, dropout=dropout, expansion=expansion)

        self.enc5 = FrameEncoder2(channels * 6, channels * 8, n_fft=n_fft, downsamples=3)
        self.enc5_primer = FramePrimerEncoder2(channels * 8, num_heads=num_heads[4], n_fft=n_fft, downsamples=4, dropout=dropout, expansion=expansion)
