...
class FramePrimer2(nn.Module):
    def __init__(self, in_channels=2, channels=2, dropout=0.1, n_fft=2048, feedforward_dim=2048, num_res_blocks=1, column_kernel=True):
        ...
        self.enc2_primer = FramePrimerEncoder(channels * 2, num_bands=bands[1], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=1, dropout=dropout, bottleneck=bottlenecks[1])
        ...
        self.enc3_primer = FramePrimerEncoder(channels * 4, num_bands=bands[2], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=2, dropout=dropout, bottleneck=bottlenecks[2])
        ...
        self.enc4_primer = FramePrimerEncoder(channels * 6, num_bands=bands[3], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=3, dropout=dropout, bottleneck=bottlenecks[3])
        ...
        self.enc5_primer = FramePrimerEncoder(channels * 8, num_bands=bands[4], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=4, dropout=dropout, bottleneck=bottlenecks[4])
        ...
        self.enc6_primer = FramePrimerEncoder(channels * 10, num_bands=bands[5], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=5, dropout=dropout, bottleneck=bottlenecks[5])
        ...
        self.dec5_primer = FramePrimerDecoder(channels * 8, channels * 8 + bottlenecks[4], num_bands=bands[4], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=4, dropout=dropout, bottleneck=bottlenecks[4])
        ...
        self.dec4_primer = FramePrimerDecoder(channels * 6, channels * 6 + bottlenecks[3], num_bands=bands[3], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=3, dropout=dropout, bottleneck=bottlenecks[3])
        ...
        self.dec3_primer = FramePrimerDecoder(channels * 4, channels * 4 + bottlenecks[2], num_bands=bands[2], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=2, dropout=dropout, bottleneck=bottlenecks[2])
        ...
        self.dec2_primer = FramePrimerDecoder(channels * 2, channels * 2 + bottlenecks[1], num_bands=bands[1], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=1, dropout=dropout, bottleneck=bottlenecks[1])
        ...
        self.dec1_primer = FramePrimerDecoder(channels * 1, channels * 1 + bottlenecks[0], num_bands=bands[0], n_fft=n_fft, feedforward_dim=feedforward_dim, downsamples=0, dropout=dropout, bottleneck=bottlenecks[0])
