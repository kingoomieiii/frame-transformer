...
def main():
    ...
    p.add_argument('--expansion', type=int, default=6)
    ...
    model = FrameTransformer(in_channels=2, channels=args.channels, n_fft=args.n_fft, expansion=args.expansion, num_heads=args.num_heads)
