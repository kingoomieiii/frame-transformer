...
def main():
    ...
    pafnet = FrameTransformer(in_channels=4, out_channels=2, channels=args.channels, dropout=args.dropout, n_fft=args.n_fft, num_heads=args.num_heads, expansion=args.expansion)
