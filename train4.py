...
def main():
    ...
    p.add_argument('--epochs', type=str, default='25,40')
    ...
    scheduler = torch.optim.lr_scheduler.ChainedScheduler([
        ...
        PolynomialDecayScheduler(optimizer, target=args.lr_scheduler_decay_target, power=args.lr_scheduler_decay_power, num_decay_steps=decay_steps, start_step=warmup_steps, current_step=args.curr_step, verbose_skip_steps=args.lr_verbosity)
    ])
