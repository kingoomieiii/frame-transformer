...
from frame_transformer3 import FrameTransformer
...
def main():
    ...
    p.add_argument('--accumulation_steps', '-A', type=str, default='4,16')
    ...
    model = FrameTransformer(in_channels=2, channels=args.channels, num_layers=args.num_layers, expansion=args.feedforward_expansion, num_heads=args.num_heads, n_fft=args.n_fft, dropout=args.dropout)
